...
const Tours = () => {
  return (
    ...
    // add hover effect from cards component in video
    <div className="bg-white text-gray-900 w-full py-16 px-4">
        <div className="max-w-[1240px] mx-auto grid grid-cols-2 md:grid-cols-4">
            ...
            <img className='w-[90%] h-[200px] mx-auto bg-red-300' src='' alt="/" />
            <div className='flex flex-col justify-center mb-3 mx-auto'>
                <p className='text-[#00df9a] uppercase font-bold'>Municipio, PR</p>
